...
Phone.prototype.printInfo = function() {
	console.log("The phone brand is " + this.brand + ", color is " + this.color + ", the price is " + this.price + " and the avalibility is " + this.avalibility + ".");
}
...
var SamsungJ5 = new Phone("Samsung", 500, "gold", "not available");
